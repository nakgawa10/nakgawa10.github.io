...
import image from "../components/images/final_me.svg";
        ...
        <div className="content">
          <div className="one_liner">
            ...
            <div className="button-resume">
              <a href="./Nakul.pdf">Resume</a>
              <p>
                I'm Nakul, a software developer and tech enthusiast with a
                passion for creating innovative solutions to complex problems.
                When I'm not busy tinkering with code, you can find me exploring
                new hiking trails, or capturing stunning photos with my camera.
              </p>
            </div>
          </div>
        </div>
